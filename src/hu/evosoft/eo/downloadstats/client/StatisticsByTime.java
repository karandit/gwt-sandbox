...
public class StatisticsByTime extends DockLayoutPanel {
	...
	private void draw() {
		...
		stateRange.setStart(createDate(2012, 2, 9));
		stateRange.setEnd(createDate(2012, 3, 20));
		...
		for (int day = 1; day < 121; ++day) {
			...
			dataTable.setValue(day, 0, createDate(2012, 1, day));
